...
<div class="form-group edit-form">
    ...
    <div class="col-md-11 col-sm-11 col-xs-12">
        <div class="input-group" style="padding-top:5px;">
            ...
            <input type="radio" class="" placeholder="" id="QNALV1" name="questiontypelv" value="QNALV1" onclick="onCheckQuestType(this);" disabled> <label for="QNALV1" style="margin-left:5px;"> Level 1</label>
            <input type="radio" class="" placeholder="" id="QNALV2" name="questiontypelv" value="QNALV2" style="margin-left:15px;" onclick="onCheckQuestType(this);" disabled> <label for="QNALV2" style="margin-left:5px;"> Level 2</label>
            <input type="radio" class="" placeholder="" id="QNALV5" name="questiontypelv" value="QNALV5" style="margin-left:15px;" onclick="onCheckQuestType(this);" disabled> <label for="QNALV5" style="margin-left:5px;"> Level 5</label>
        </div>
    </div>
</div>
<div class="form-group edit-form">
    ...
    <div class="form-group edit-form">
        ...
        <div class="col-md-11 col-sm-11 col-xs-12">
            <div class="input-group" style="padding-top:5px;">
                ...
                <input type="radio" class="" placeholder="" name="questiontypelv" id="QNALV1" value="QNALV1" ${qnaLv1Checked} onclick="onCheckQuestType(this);" disabled > <label for="QNALV1" style="margin-left:5px;"> Level 1</label>
                <input type="radio" class="" placeholder="" name="questiontypelv" id="QNALV2" value="QNALV2" style="margin-left:15px;" ${qnaLv2Checked} onclick="onCheckQuestType(this);" disabled> <label for="QNALV2" style="margin-left:5px;"> Level 2</label>
                <input type="radio" class="" placeholder="" name="questiontypelv" id="QNALV5" value="QNALV5" style="margin-left:15px;" ${qnaLv5Checked} onclick="onCheckQuestType(this);" disabled> <label for="QNALV5" style="margin-left:5px;"> Level 5</label>
            </div>
        </div>
    </div>
    <div class="form-group edit-form">
